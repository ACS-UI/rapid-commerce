...
// instance.unmount();`;function v(){return e("div",{style:h,children:[e("h1",{style:m,children:"Universal Storefront UI"}),e("p",{style:f,children:"A configurable e-commerce component library built with Preact for modern storefronts. It works with Preact, React, or vanilla JavaScript and is designed for headless or hybrid setups where you own the page shell and plug in UI where needed."}),e("ul",{style:y,children:[e("li",{children:["Framework-friendly: use as Preact/React components or via vanilla ",e("code",{children:".render()"})]}),e("li",{children:"Pluggable commerce: generic interfaces with an Adobe Commerce (Magento) implementation"}),e("li",{children:"Responsive, accessible (WCAG 2.1 AA), and themeable via CSS custom properties (tokens)"})]}),e("h2",{style:t,children:"Pages"}),e("p",{style:{margin:"0 0 var(--usf-space-2)",fontSize:"var(--usf-font-size-sm)",color:"var(--usf-text-secondary)"},children:"Full-page flows: cart, checkout, product details, order confirmation."}),e("ul",{style:s,children:[e("li",{children:e("a",{href:"?path=/story/pages-cart--default",style:r,children:"Cart"})}),e("li",{children:e("a",{href:"?path=/story/pages-checkout--default",style:r,children:"Checkout"})}),e("li",{children:e("a",{href:"?path=/story/pages-productdetails--default",style:r,children:"Product Details"})}),e("li",{children:e("a",{href:"?path=/story/pages-orderdetails--default",style:r,children:"Order Details"})})]}),e("h2",{style:t,children:"Components"}),e("p",{style:{margin:"0 0 var(--usf-space-2)",fontSize:"var(--usf-font-size-sm)",color:"var(--usf-text-secondary)"},children:"Building blocks: product card, grid, filters, pagination, sort, mini cart, recommendations."}),e("ul",{style:s,children:[e("li",{children:e("a",{href:"?path=/story/components-productcard--default",style:r,children:"Product Card"})}),e("li",{children:e("a",{href:"?path=/story/components-productgrid--default",style:r,children:"Product Grid"})}),e("li",{children:e("a",{href:"?path=/story/components-filterpanel--default",style:r,children:"Filter Panel"})}),e("li",{children:e("a",{href:"?path=/story/components-pagination--default",style:r,children:"Pagination"})}),e("li",{children:e("a",{href:"?path=/story/components-sortcontrols--default",style:r,children:"Sort Controls"})}),e("li",{children:e("a",{href:"?path=/story/components-minicart--default",style:r,children:"Mini Cart"})}),e("li",{children:e("a",{href:"?path=/story/components-productrecommendations--default",style:r,children:"Product Recommendations"})})]})]})}function S(){return e("div",{style:h,children:[e("h1",{style:m,children:"Setup"}),e("p",{style:f,children:["Install the packages, load the library styles, then mount components with the ",e("code",{children:".render()"})," API. For a full vanilla JS example including ",e("code",{children:"beforeRender"})," and ",e("code",{children:"afterRender"}),", see below."]}),e("h2",{style:t,children:"1. Install"}),e("pre",{style:a,children:"npm install @universal-sf-ui/product @universal-sf-ui/adobe-commerce"}),e("h2",{style:t,children:"2. Load styles"}),e("p",{style:{margin:"0 0 0.25rem",fontSize:"var(--usf-font-size-sm)",color:"var(--usf-text-secondary)"},children:"Include the library tokens and base styles (paths depend on your build or CDN):"}),e("pre",{style:a,children:`<link rel="stylesheet" href="/path/to/tokens.css">
<link rel="stylesheet" href="/path/to/style.css">`}),e("h2",{style:t,children:"3. Use a component"}),e("p",{style:{margin:"0 0 0.5rem",fontSize:"var(--usf-font-size-sm)",color:"var(--usf-text-secondary)"},children:["With vanilla JS, call ",e("code",{children:".render(container, props, options)"}),". The third argument is optional and can include ",e("code",{children:"beforeRender"})," and ",e("code",{children:"afterRender"})," callbacks. Example with ProductDetails:"]}),e("pre",{style:a,children:g})]})}const k={title:"Introduction",parameters:{layout:"fullscreen",docs:{description:{component:"Universal Storefront UI: overview, architecture, and setup for vanilla JS."}}},tags:["autodocs"]},n={render:()=>e(v,{}),parameters:{docs:{description:{story:"Overview, description, and architecture. Use the sidebar to open Pages and Components."}}}},o={render:()=>e(S,{}),parameters:{docs:{description:{story:"Install, load CSS, and a full JavaScript example using ProductDetails.render() with beforeRender and afterRender."}}}};var i,l,c;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
...
}`,...(c=(l=n.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};var d,p,u;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => <SetupContent />,
  parameters: {
    docs: {
      description: {
...
}`,...(u=(p=o.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};const P=["Welcome","Setup"];export{o as Setup,n as Welcome,P as __namedExportsOrder,k as default};
