...
}`,...(w=(y=u.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var C,$,D;m.parameters={...m.parameters,docs:{...(C=m.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    store: productListStore,
    columns: {
      mobile: 2,
...
}`,...(D=($=m.parameters)==null?void 0:$.docs)==null?void 0:D.source}}};var M,V,v;l.parameters={...l.parameters,docs:{...(M=l.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    store: productListStore
  },
  render: args => {
...
}`,...(v=(V=l.parameters)==null?void 0:V.docs)==null?void 0:v.source}}};var E,T,_;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    store: productListStore,
    gap: 'lg',
    columns: {
...
}`,...(_=(T=p.parameters)==null?void 0:T.docs)==null?void 0:_.source}}};const j=["Default","TwoColumns","FiveColumns","Loading","Empty","ListView","WithGaps"];export{a as Default,m as Empty,d as FiveColumns,l as ListView,u as Loading,c as TwoColumns,p as WithGaps,j as __namedExportsOrder,W as default};
